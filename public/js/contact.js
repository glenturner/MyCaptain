...
$(document).ready(function() {
    ...
    $('#contact-form .input-field').on('blur',function(){
    ...
    $('#contact-form .materialize-textarea').each(function(){
    ...
    $('#contact-form .materialize-textarea').on('blur',function(){
    ...
    $('#contact-form .materialize-textarea').on('focus',function(){
        $(this).parent('.controls').find('.error-message').fadeOut(300);
    });
    ...
    $('#contact-form').submit(function() {
        ...
        if(hasError) {
            ...
            $.post($(this).attr('action'),formInput, function(data){
                ...
                $('#contact-form .input-field').removeClass('input-filled');
            });
